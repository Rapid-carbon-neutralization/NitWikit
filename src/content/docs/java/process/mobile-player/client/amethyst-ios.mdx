...
这只是U盘的使用流程，如果你是 Linux 或者 macOS 你应该使用他们自己的安装方法。
...
然后从此 [链接](https://github.com/AngelAuraMC/Amethyst-iOS/actions) 下载 Amethyst 的 ipa 安装包。**（需要使用 GitHub 账号才能继续下载）**
